...
export async function recordVendorReliabilityController(
...
export async function getVendorHistoryController(
  req: Request<{ vendorId: string }>,
  res: Response,
) {
  try {
...
export async function findReliabilityRecordController(
  req: Request<{
    vendorId: string;
